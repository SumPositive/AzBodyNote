...
@property (nonatomic, retain) NSNumber   *markBpLower_mmHg;
@property (nonatomic, retain) NSNumber   *markBpUpper_mmHg;
...
@property (nonatomic, retain) NSNumber   *bpLower_mmHg;
@property (nonatomic, retain) NSNumber   *bpUpper_mmHg;

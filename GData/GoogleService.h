...
#define GS_KC_ServiceName					@"ConditionGSKC"
#define GS_KC_LoginName						@"GS_KC_LoginName"
#define GS_KC_LoginPassword					@"GS_KC_LoginPassword"

#define GS_DOC_FOLDER_NAME				@"Condition"
#define GS_PHOTO_ALBUM_NAME			@"Condition"
#define GS_PHOTO_UUID_PREFIX				@"Condition:"	//この後にUUIDが続く。 setPhotoDescriptionWithString:でセット
